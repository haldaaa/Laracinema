...
@section('content')
    <div class="panel panel-system">
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="{{route('categories_store',['id' => $categories->id])}}" method="post" class="panel-body" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group has-info">
                            ...
                            <input placeholder="Type categorie : Fantastique, Comédie..." required type="text" name="titre" class="form-control" value="{{$categories->title}}">
                        ...
                        <div class="form-group has-info">
                            ...
                            <div class="input-group">
                                ...
                                <textarea  name="description" class="markdown  form-control" placeholder="Description de la categorie" >{{$categories->description}}</textarea>
                            </div>
