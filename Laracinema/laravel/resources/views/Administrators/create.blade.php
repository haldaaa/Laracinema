...
@section('content')
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="text-center">Création admin</h3>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <form  enctype="multipart/form-data" action=" {{route('administrators_store')}}" method="post" class="panel-body" >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group has-info">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"> <i class="fa fa-pencil"> </i> </span>
                        <input placeholder="" required type="password" name="password" class="form-control">
                    ...
                    <div class="form-group has-info">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"> <i class="fa fa-pencil"> </i> </span>
                        <input placeholder="" required type="password" name="password_confirmation" class="form-control">
                    </div>
                        </br>
                    ...
                    <div class="form-group has-info">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"> <i class="fa fa-pencil"> </i> </span>
                        <input placeholder="Email" required type="text" name="email" class="form-control">
                    </div>
                        </br>
